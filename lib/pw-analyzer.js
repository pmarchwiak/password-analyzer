...
function analyze(options, callback) {
  ...
  passwords.search({onComplete:
    function (credentials) {
      ...
      console.debug("Dupes: " + dupes.toSource());
      ...
      console.debug(results.toSource());
...
function testEntropy(result) {
  ...
  var entr = entropy(pw);
  console.debug("Entropy for " + pw + " is " + entr);
